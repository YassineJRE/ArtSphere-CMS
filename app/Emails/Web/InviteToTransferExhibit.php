...
class InviteToTransferExhibit extends Mailable
{
    use Queueable;
    ...
    {
        return $this
            ->subject(__('emails.app.InviteToTransferExhibit.subject'))
            ->markdown('emails.inviteToTransferExhibit', [
                'invitation' => $this->invitation,
                'actionText' => __('emails.app.InviteToTransferExhibit.action-text'),
