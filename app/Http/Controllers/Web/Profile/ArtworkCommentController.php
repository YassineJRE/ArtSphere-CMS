...
use App\Http\Requests\Web\Profile\ArtworkComment\StoreRequest;
use App\Http\Controllers\Web\BaseController;
use App\Models\Artwork;
use App\Models\Exhibit;
use App\Models\UserProfile;
use App\Services\Web\Profile\ArtworkCommentService;
...
class ArtworkCommentController extends BaseController
{
     ...
     * @return Response
     */
    public function store(StoreRequest $request, UserProfile $profile, Exhibit $exhibit, Artwork $artwork)
    {
        try {
