...
use App\Repositories\Web\MyAccountRepository;

class MyAccountService extends BaseService
{
    public function __construct(MyAccountRepository $repository)
    {
    ...
    /**
     * Change my password of my account.
     *
