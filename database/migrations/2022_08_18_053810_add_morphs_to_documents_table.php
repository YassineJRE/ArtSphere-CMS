...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        if (Schema::hasColumn('documents', 'owner_type') && Schema::hasColumn('documents', 'owner_id'))
        {
            DB::statement(
                "UPDATE documents
        ...
        if (Schema::hasColumn('documents', 'user_profile_id'))
        {
            Schema::table('documents', function (Blueprint $table) 
            {
    ...
    {
        if (!Schema::hasColumn('documents', 'user_profile_id') && !Schema::hasColumn('documents', 'group_id'))
        {
            Schema::table('documents', function (Blueprint $table) 
            {
