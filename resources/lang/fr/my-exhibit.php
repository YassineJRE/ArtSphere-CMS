    ...
    'views' => [
        ...
        'create' => [
            ...
            'form' => [
                'p' => [
                    ...
                    'transfer-text' => 'Vous ne pouvez pas publier d\'expositions mais vous pouvez la transférer à l\'artiste propriétaire. Elle sera ajoutée à votre collection.'
                ],
            ],
        ],
        'edit' => [
        ...
        'show' => [
                ...
                'li' => [
                    'button' => [
                        ...
                        'h3' => [
                            ...
                            'transfer-artwork' => 'Transférer l\'œuvre',
                        ],
                        'p' => [
                            'sure' => 'Êtes vous sûr ?',
                            'choose-exhibit' => 'Choisissez l\'Exposition',
                        ],
                        'form' => [
                            'button' => [
                                'delete' => 'Supprimer',
            ...
            'footer' => [
                ...
                'additional-information-title' => 'Ajoutez un titre',
                'grant-acknowledgement' => 'Accorder la reconnaissance:',
                'type' => 'Type:',
                'upcoming-date' => 'Exposition à venir',
                ...
                'button' => [
                    ...
                    'transfer' => 'Envoyer',
                    'resend-invitation-mail' => 'Renvoyer le courrier d\'invitation',
                    'view' => 'Visualiser',
                ],
                'a' => [
                    'advanced' => 'Options de Téléchargement',
                ],
                'label' => [
                    'filetype' => 'Sélectionner le type de fichier:',
                    'artworks' => 'Sélectionner la documentation à télécharger:',
                ],
                'h3' => [
