...
@section('title')
    {{ __('my-artist-group.views.create.title.add-artist-group') }}
    @parent
@endsection

@section('page-title')
{{ __('my-artist-group.views.create.page-title.add-artist-group') }}
@stop

@section('breadcrumbs')
    @include('components.breadcrumbs', ['breadcrumbs' => [
        __('my-artist-group.views.create.breadcrumbs.my-account') => route('my-account.index'),
        __('my-artist-group.views.create.breadcrumbs.add-artist-group')
    ]])
@stop
...
<div class="container woocommerce">
    ...
    <div class="woocommerce col-md-12">
        <form
            action="{{ route('my-account.artist-group.store') }}"
            class="register"
            method="post"
        >
            @csrf
            <div class="form-row col-md-6">
                <label for="name">{{ __('my-artist-group.views.create.form.p.label.group-name') }} <span class="required">*</span></label>
                <input
                    type="text"
            ...
            <div class="form-row col-md-6">
                <label for="address">{{ __('my-artist-group.views.create.form.p.label.address') }}</label>
                <input
                    type="text"
            ...
            <div class="form-row col-md-6">
                <label for="city">{{ __('my-artist-group.views.create.form.p.label.city') }}</label>
                <input
                    type="text"
            ...
            <div class="form-row col-md-6">
                <label for="country">{{ __('my-artist-group.views.create.form.p.label.country') }} <span class="required">*</label>
                <input
                    type="text"
            ...
            <div class="form-row col-md-12">
                <label for="member_of">{{ __('my-artist-group.views.create.form.p.label.member-of') }}</label>
                <input
                    type="text"
            ...
            <div class="form-row col-md-12">
                <label for="biography">{{ __('my-artist-group.views.create.form.p.label.biography') }} <span class="required">*</label>
                <textarea
            ...
            <div class="form-row col-md-6">
                <label for="art_practice_type">{{ __('my-artist-group.views.create.form.p.label.art-practice-type') }}</label>
                <select
                ...
                <div class="specify_art_practice_type @if(@old('art_practice_type') != 'other') hidden @endif">
                    <label for="specify_art_practice_type">{{ __('my-artist-group.views.create.form.p.label.specify') }}</label>
                    <input
                        type="text"
            ...
            <div class="form-row col-md-12 margin-top-15">
                <p>{{ __('my-artist-group.views.create.form.p.label.additional-information-content') }}</p>
            </div>
            <div class="form-row col-md-6">
                <input
                    type="text"
                    ...
                    placeholder="{{ __('my-artist-group.views.create.form.p.label.additional-information-title') }}"
                >
            ...
            <div class="form-row col-md-12">
                ...
                <input
                    ...
                    class="button"
                    name="create"
                    value="{{ __('my-artist-group.views.create.form.p.button.create') }}">
            </div>
        </form>
    </div>
</div>
