...
@section('breadcrumbs')
    @include('components.breadcrumbs', ['breadcrumbs' => [
        ...
        __('my-curator-group.views.edit.breadcrumbs.edit')
    ]])
@stop
    ...
    <div class="woocommerce col-md-12">
        ...
        >
            ...
            <div class="form-row col-md-12">
                <label for="name">{{ __('my-curator-group.views.edit.form.p.label.group-name') }} <span class="required">*</span></label>
                <input
                    type="text"
            ...
            <div class="form-row col-md-6">
                <label for="address">{{ __('my-curator-group.views.edit.form.p.label.address') }}</label>
                <input
                    type="text"
            ...
            <div class="form-row col-md-6">
                <label for="city">{{ __('my-curator-group.views.edit.form.p.label.city') }}</label>
                <input
                    type="text"
            ...
            <div class="form-row col-md-6">
                <label for="country">{{ __('my-curator-group.views.edit.form.p.label.country') }} <span class="required">*</label>
                <input
                    type="text"
            ...
            <div class="form-row col-md-6">
                <label for="member_of">{{ __('my-curator-group.views.edit.form.p.label.member-of') }}</label>
                <input
                    type="text"
            ...
            <div class="form-row col-md-12">
                <label for="biography">{{ __('my-curator-group.views.edit.form.p.label.biography') }}</label>
                <textarea
            ...
            <div class="form-row col-md-12 margin-top-15">
                <p>{{ __('my-curator-group.views.edit.form.p.label.additional-information-content') }}</p>
            </div>
            <div class="form-row col-md-6">
                <input
                    type="text"
                    ...
                    placeholder="{{ __('my-curator-group.views.edit.form.p.label.additional-information-title') }}"
                >
            ...
            <div class="form-row col-md-6">
                <label for="status">{{ __('my-curator-group.views.edit.form.p.label.status') }}</label>
                <select
            ...
            <div class="form-row col-md-12">
                ...
                <input
                    ...
                    class="button"
                    name="save"
                    value="{{ __('my-curator-group.views.edit.form.p.button.save') }}">
            </div>
        </form>
    </div>
</div>
