...
<body>
    <div id="wrapper"
        class="
                @if (str_starts_with(Route::currentRouteName(), 'app.')) discover
                @elseif(str_starts_with(Route::currentRouteName(), 'my-group.')) 
                    my-group
                @elseif(str_starts_with(Route::currentRouteName(), 'my-profile.'))
                    my-profile @endif">
    ...
    <script src="{{ asset('js/scripts/moment.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('js/scripts/daterangepicker.js') }}" type="text/javascript"></script>
    ...
    <script src="{{ asset('js/scripts/uploadzone.js') }}" type="text/javascript"></script>
